	...
	<nav class="navbar-default navbar-static-side" role="navigation">
		<div class="sidebar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li><a href="#"> <img alt="image" class="tit-image"
						src="<%=path %>/images/service-red.svg" /> <span
						class="nav-label">服务</span> <span class="fa arrow"></span>
				</a>
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem" href="">服务管理</a></li>
						<li><a class="J_menuItem" href="">存储与备份</a></li>
						<li><a class="J_menuItem" href="">引入外部服务</a></li>
					</ul></li>
				<li><a href="#"> <img alt="image" class="tit-image"
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem" href="">镜像构建</a></li>
				...
				<li><a href="#"> <img alt="image" class="tit-image"
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem" href="">镜像中心</a></li>
						<li><a class="J_menuItem" href="">我的镜像</a></li>
						<li><a class="J_menuItem" href="">我的收藏</a></li>
					</ul></li>
				<li><a href="#"> <img alt="image" class="tit-image"
				...
				<li><a href="#"> <img alt="image" class="tit-image"
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem" href="">容器监控</a></li>
						<li><a class="J_menuItem" href="">集群拓扑</a></li>
					</ul></li>
				<li><a href="#"> <img alt="image" class="tit-image"
					...
					<ul class="nav nav-second-level">
						<li><a class="J_menuItem" href="">dockerfile</a></li>
						<li><a class="J_menuItem" href="">环境变量</a></li>
					</ul></li>
				<li><a href="#"> <img alt="image" class="tit-image"
