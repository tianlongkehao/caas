                            ...
                            <div class="step-inner" style="left: 0%;">
                                ...
                                <%--选择集群节点--%>
                                    <div class="host_step1" >
                                        <div class="blankapp" style="width: 90%; text-align: center">
                                            <div class="row" style="margin-left: 54px;">
                                                <div>
                                                    ...
                                                    <span class="checkIp pull-right btn btn-primary pull_confirm">查找</span>
                                                </div>
                                                <div >
                                                    <table class="table table-hover enabled" id="ipRange" style="margin-top: 25px">
                                                        <thead>
                                        ...
                                        <div class="list-item-description" style="padding-top: 100px">
                                            <a href="/cluster/list"><span class="btn btn-default go_user" style="margin-right: 30px;">返回</span></a>
                                            <span class="nextTwo pull-right btn btn-primary pull_confirm" data-attr="tenxcloud/mysql">下一步</span>
                                        </div>
                                    </div>
                                ...
                                <div class="host_step2" >
                                    ...
                                    <ul class="safeSet" style="margin-left: 100px">
                                        ...
                                        <li class="line-h-3">
                                            <div class="param-set">
                                                ...
                                                <input type="text" class="form-control" placeholder="root" style="width: 78%;display: inline">
                                            </div>
                                        </li>
                                        <li class="line-h-3">
                                            <div class="param-set">
                                        ...
                                        <li class="line-h-3">
                                            <div class="param-set">
                                                ...
                                                <input type="text" class="form-control" placeholder="22" style="width: 78%;display: inline">
                                            </div>
                                        </li>
                                    ...
                                    <div class="" style="padding-top: 100px">
                                        ...
                                        <span id="checkBtn" class="checkBtn pull-right btn btn-primary pull_confirm">下一步</span>
                                    </div>
                                </div>
                                ...
                                <div class="host_step3" style="float:left">
                                    <div>
                                        <table class="table table-hover enabled" >
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center"><input type="checkbox" class="chkAll"/></td>
                                                <td style="text-align: center"><input type="checkbox" class="chkAll"/></td>
                                                <td style="text-align: center"><input type="checkbox" class="chkAll"/></td>
                                            </tr>
                                    ...
                                    <div class="" style="padding-top: 100px">
                                        <span class="btn btn-default last_step" style="margin-right: 30px;">上一步</span>
                                        <span id="installBtn" class="installBtn pull-right btn btn-primary pull_confirm">安装</span>
                                    </div>
                                </div>
                                    <%--4.配置集群节点--%>
                                <div class="host_step4" style="height: auto;float: right">
                                    ...
                                    <div class="" style="padding-top: 100px">
                                        <span class="btn btn-default last_step" style="margin-right: 30px;">上一步</span>
                                        <a href="/cluster/list"><span id="finishBtn" class="pull-right btn btn-primary pull_confirm">完成</span></a>
                                    </div>
                                </div>
