	...
	<div class="page-container">
		<article>
			<div class="page-main">
						...
						<c:forEach items="${nodeList}" var="node">
							<div class="checkbox">
								<input name="node" type="checkbox" checked
									value="${node.metadata.name }">${node.metadata.name }
							</div>
						</c:forEach>
					</div>
					<div class="caption clearfix"
						...
						<div>
							ping <input type="text" id="pingip" placeholder="主机IP" value="192.168.0.75" />
							平均响应时间小于:<input type="number" value="10" class="number" min="1"
								autocomplete="off" max="" placeholder="1" id="pingtime"
								onkeyup="this.value=this.value.replace(/\D/g,'')"
								name="instanceNum"><span class="s-unit">ms</span> <a
								id="pinglink" style="float: right" href="javascript:void(0)"
								onclick="pingdetail()" title="查看详细信息"
						...
						<div>
							time tracepath <input type="text" id="tracepathip"
								placeholder="主机IP" value="192.168.0.75" /> 平均响应时间小于:<input type="number"
								value="2" class="number" min="1" autocomplete="off" max=""
								placeholder="1" id="tracepathtime"
								onkeyup="this.value=this.value.replace(/\D/g,'')"
								name="instanceNum"><span class="s-unit">s</span> <a
								id="tracepathlink" style="float: right"
								href="javascript:void(0)" onclick="tracepathdetail()"
						...
						<div>
							time curl 响应时间小于:<input type="number" value="2" class="number"
								...
								onkeyup="this.value=this.value.replace(/\D/g,'')"
								name="instanceNum"><span class="s-unit">s</span> <a
								id="curllink" style="float: right" href="javascript:void(0)"
								onclick="curldetail()" title="查看详细信息"
								onmousemove="style.textDecoration='underline'"
								onmouseout="style.textDecoration='none'"></a>
						</div>
						<div>
							...
							<input type="number" value="2000" class="number" min="1"
								...
								onkeyup="this.value=this.value.replace(/\D/g,'')"
								name="instanceNum"> <a id="qperflink"
								style="float: right" href="javascript:void(0)"
								onclick="qperfdetail()" title="查看详细信息"
								onmousemove="style.textDecoration='underline'"
								onmouseout="style.textDecoration='none'"></a>
						</div>
						<div>
							...
							<input type="number" value="15" class="number" min="1"
								...
								onkeyup="this.value=this.value.replace(/\D/g,'')"
								name="instanceNum"><span class="s-unit">GB</span> <a
								id="dockerlink" style="float: right" href="javascript:void(0)"
								title="查看详细信息"
								onmousemove="style.textDecoration='underline'"
								onmouseout="style.textDecoration='none'"></a>
						</div>
						<div>
							dns <a id="dnslink" style="float: right"
								href="javascript:void(0)" onclick="dnsdetail()" title="查看详细信息"
								onmousemove="style.textDecoration='underline'"
								onmouseout="style.textDecoration='none'"></a>
				...
				<div id="pingdetail" style="display: none;"></div>
				<div id="tracepathdetail" style="display: none;"></div>
				<div id="curldetail" style="display: none;"></div>
				<div id="qperfdetail" style="display: none;"></div>
				<div id="dockerdetail" style="display: none;">
					<table class="table enabled"
						style="width: 580px; padding: 5px; margin: 10px">
						<thead>
							<tr>
								<th style="width: 30%; text-align: center;">Node名称</th>
								<th style="width: 30%; text-align: center;">Cpu</th>
								<th style="width: 30%; text-align: center;">Memory</th>
							</tr>
						</thead>
				...
				<div id="dnsdetail" style="display: none;"></div>
			</div>
		</article>
	</div>
</body>
