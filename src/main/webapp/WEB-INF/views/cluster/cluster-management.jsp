					...
					<div class="col-md-12">
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								<h5>
									<i class="fa fa-map-marker" style="margin-right: 6px;"></i>集群管理
								</h5>
								<div class="ibox-tools">
									<a href="<%=path %>/cluster/add" id="userCreateBtn" title="创建集群节点"><i
					...
					<div class="ibox-content">
						<div class="searchs">
							<form class="form-inline"
								action="<%=path%>/cluster/searchCluster" method="post">
								<div class="form-group">
									<div class="input-group">
										<input type="text" class="form-control"
											placeholder="搜索IP地址关键字" name="searchIP"> <span
											class="input-group-btn">
											<button class="btn btn-default btn-color" type="submit">
									...
									<c:if test="${cur_cluster.host != cluster.host}">
										<tr class="clusterTr" id="${cluster.host }">
											...
											<td style="width: 20%; padding-left: 5px;"
												value="${cluster.host }"><a
												href="<%=path %>/cluster/detail?hostIps=${cluster.host }"
												title="查看详细信息"
							...
							<div class="caption clearfix">
								<ul class="toolbox clearfix hide">
									<li><a href="javascript:window.location.reload(true);"
										id="clusterReloadBtn"><i class="fa fa-repeat"></i></a></li>
								...
								<div id="changeConf" style="display: none">
									<ul class="popWin">
										...
										<li class="line-h-3">
											<div class="param-set">
												<span>CPU数量：</span> <input type="number" value="1"
													style="margin-top: 10px; width: 165px;" min="1"
													autocomplete="off" placeholder="1" id="" name=""> <span
													class="unit">个</span>
											</div>
										</li>
										<li class="line-h-3">
											<div class="param-set">
												<span>内存：</span> <input id="confRamSlider"
													data-slider-id='confRamSlider' type="text"
													data-slider-min="0" data-slider-max="2024"
													data-slider-step="1" data-slider-value="256" /> <input
													type="text" value="256" id="confRam" name="confRam">
												<span>M</span>
											</div>
										</li>
									</ul>
