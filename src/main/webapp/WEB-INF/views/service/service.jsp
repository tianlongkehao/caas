				...
				<div class="contentMain">
					<aside class="aside-btn hide">
						<div class="btns-group">
							<span class="btn btn-defaults btn-white"><i
								class="fa fa-map-marker"></i><span class="ic_left">BCM</span></span>
						</div>
					</aside>
					<div class="caption clearfix hide">
						<ul class="toolbox clearfix">
							...
							<li><a href="<%=path%>/service/add" id="serviceCreateBtn"><i
									class="fa fa-plus"></i>&nbsp;&nbsp;创建</a></li>
							<li class="dropdown"><a data-toggle="dropdown"
								href="javascript:void(0);">更多操作&nbsp;&nbsp;<i
									class="fa fa-caret-down"></i></a>
								<ul class="dropdown-menu serviceOperation">
									<li><a id="startContainer" class="no-drop"
										href="javascript:createContainer()"> <i class="fa fa-play"></i>
											<span class="ic_left">启动</span>
									</a></li>
									<li><a id="stopContainer" class="no-drop"
										href="javascript:stopContainer()"> <i
											class="fa fa-power-off"></i> <span class="ic_left">停止</span>
									</a></li>
									<li><a id="scaleCluster" class="no-drop"
										href="javascript:upGradeContainer()"> <i
											class="fa fa-arrows"></i> <span class="ic_left">弹性伸缩</span>
									</a></li>
									<li><a id="upgradeCluster" class="no-drop"
										href="javascript:versionUpgrade()"> <i
											class="fa fa-arrow-up"></i> <span class="ic_left">版本升级</span>
									</a></li>
									<!-- <li>
									...
									<li><a id="changeConfiguration" class="no-drop"
										href="javascript:changeContainerConf();"> <i
											class="fa fa-cog"></i> <span class="ic_left">更改配置</span>
									</a></li>

									<li><a id="deleteButton" class="no-drop"
										href="javascript:delContainer()"> <i class="fa fa-trash"></i>
						...
						<div id="upgrade" style="display: none">
							<ul class="popWin">
								<li class="line-h-3"><span class="edit-name-c">服务名称：</span>
								...
								<li class="line-h-3" id="instsizeChange">
									<div class="param-set">
										...
										<input value="1" id="numberChange" class="" min="1" max=""
						...
						<div id="versionUpgrade" style="display: none">
							<ul class="popWin">
								<li class="line-h-3"><span class="edit-name-c">服务名称：</span>
									<input id="upgradeVersionServiceName" disabled="disabled"
									style="margin-top: 5px; width: 165px;" type="text" value="">
								</li>
								<li class="line-h-3"><span class="edit-name-c">镜像名称：</span>
									<input id="upgradeimgName" disabled="disabled"
									style="margin-top: 5px; width: 165px;" type="text" value="">
								</li>
								<li class="line-h-3" id="instsizeChange">
									<div class="param-set">
								...
								<li class="line-h-3">
									<div class="param-set">
										<span>内存：</span> <input id="confRamSlider"
											...
											data-slider-min="${memorymin }"
											data-slider-max="${memorymax }" data-slider-step="1" /> <input
											type="text" left="" value="" id="confRamSlider_input"
											name="confRam"> <span>M</span>
										<!-- <span style="color: grey;">当前可用ram：<label id="leftram" ></label>M</span>-->
									</div>
								</li>
							</ul>
						</div>
						<div class="searchs hide">
							<form id="search_form" class="form-inline"
								action="<%=path%>/service/findservice" method="post">
								<div class="form-group">
									<div class="input-group">
										<input id="searchNames" name="searchNames" type="text"
											class="form-control" placeholder="搜索"> <span
											class="input-group-btn">
											<button id="serviceSearch" class="btn btn-primary"
												type="submit">
																	...
																	<table class="table">
																		<tbody>
																			...
																			<tr class="clusterId"
																				...
																				<td style="width: 8%"><a id="startContainer"
																					class="no-drop" href="javascript:createContainer()">
																						<i class="fa fa-play"></i>
																				</a> <a id="stopContainer" class="no-drop"
																					href="javascript:stopContainer()"
																					style="margin-left: 10px"> <i
																						class="fa fa-power-off"></i>
																				</a> <a id="deleteButton" class="no-drop"
																					href="javascript:delContainer()"
																					style="margin-left: 10px"> <i
																						class="fa fa-trash"></i>
																				</a></td>
																			</tr>
																				...
																				<table class="table">
																					<tbody>
																						...
																						<tr class="clusterId"
																							...
																							<td style="width: 8%"><a id="startContainer"
																								class="no-drop"
																								href="javascript:createContainer()"> <i
																									class="fa fa-play"></i>
																							</a> <a id="stopContainer" class="no-drop"
																								href="javascript:stopContainer()"
																								style="margin-left: 10px"> <i
