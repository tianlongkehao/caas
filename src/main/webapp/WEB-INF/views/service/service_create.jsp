						...
						<ul id="mountPathList">
									...
									<tbody>
										<tr>
											...
											<td><ins class="ins">
												...
												</ins> <a class="refreshVolume" title="刷新"
							...
							<li class="line-h-3"><span class="ve_top">镜像设置：</span> <span
								class="update-mi"><input type="checkbox" id="pullPolicy"
									name="pullPolicy" checked=""> <label for="pullPolicy">更新镜像</label></span>
							</li>
						</ul>
					...
					<li class="hide-set"><span class="ve_top">链接服务：</span>
						<ol class="pull-left" style="width: 100%;">
							<li class="hide-select"><select class="col col-4"
								id="linkcontainers" style="min-width: 100px; height: 28px;"><option>mysql</option></select>
									...
									<tbody id="Path-oper">
										<tr>
											...
											<td class="vals"><input type="text" placeholder="value"
												value="/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"></td>
