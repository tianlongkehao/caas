...
<meta charset="utf-8">
<link rel="stylesheet" type="text/css" href="<%=path %>/plugins/bootstrap-3.3.5/dist/css/bootstrap.css"/>
<link rel="stylesheet" type="text/css" href="<%=path %>/plugins/Font-Awesome-master/css/font-awesome.css"/>
