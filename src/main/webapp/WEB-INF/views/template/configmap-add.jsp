...
<script type="text/javascript" src="<%=path%>/js/template/configmap-add.js"></script>
</head>
<body>
			...
			<div class="page-main">
				<div class="contentTitle">
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-angle-right"></i></li>
						<li class="active" style="width: 110px">创建模板</li>
					</ol>
				</div>
						...
						<div class="steps-main">
							<div class="progre">
                                <ul style="padding: 0 4rem;">
                                    <li class="radius_step action" style="width:100%">新增配置文件模板</li>
                                </ul>
                            </div>
							<form id="buildForm" name="buildForm"
								...
								<div class="container" style="width: 90%">
									<div class="form-group ">
                                        ...
                                        <input type="hidden" name="configmapId" id="configmapId"  value = "" />
                                        <input type="text" class="form-control" name="configMapName" id="configMapName" style="width: 72%;float:left"  value = "" />
