...
<script type="text/javascript"
	src="<%=path%>/js/template/configmap-temp.js"></script>
<script type="text/javascript"
			...
			<div class="page-main">
				<div class="contentTitle">
					<ol class="breadcrumb">
						...
						<li class="active" style="width: 110px">配置文件模板</li>
					</ol>
				</div>
						...
						<div class="col-sm-12">
							<div class="ibox float-e-margins">
								<div class="ibox-title">
									<h5>
										<i class="fa fa-map-marker" style="margin-right: 6px;"></i>配置文件模板
									</h5>
									<div class="ibox-tools">
										<a href="<%=path%>/configmap/add" id="envVariableAdd"
											title="新建配置文件模板"><i class="fa fa-plus"></i>
										</a>
												...
												<tr>
													<td style="width: 5%; text-indent: 30px;">
														<input type="checkbox" class="chkItem" name="chkItem"
															autocomplete="off" id="checkboxID" value="${configmap.id }" />
													</td>
													<td style="width: 60%;text-indent:30px;">
														<a href="<%=path %>/configmap/configmapData/${configmap.id }" style="float:left;line-height:40px"
                                                            title="查看${configmap.name }详细信息"
                                                            onmousemove="style.textDecoration='underline'"
                                                            onmouseout="style.textDecoration='none'">${configmap.name }</a>
													</td>
		                                            <td style="width: 20%;">
		                                                   <fmt:formatDate value="${configmap.createDate }" pattern="yyyy-MM-dd HH:mm:ss"/>
		                                            </td>
		                                            <td style="width: 10%;text-indent: 10px;" >
														<a id="deleteButton" class="no-drop" href="javascript:oneDeleteEnvTemplate('${configmap.id }')" title="删除" style="float:left;line-height:40px">
