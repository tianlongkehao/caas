...
public enum Kind {
    ...
    SOCKETS("SOCKETS"), LOWERSOCKETS("sockets"),SOCKETSUSAGEGROUPBYNODE("SOCKETS USAGE GROUP BY NODE"),
    THREADS("THREADS"), LOWERTHREADS("threads"),THREADSUSAGEGROUPBYNODE("THREADS USAGE GROUP BY NODE"),
    ...
    CPULIMITCURRENT("cpuLimitCurrent"),CPUUSAGECURRENT("cpuUsageCurrent"),SOCKETSUSAGECURRENT("socketsUsageCurrent"),THREADSUSAGECURRENT("threadsUsageCurrent"),
    GETMEMLIMIT("getMemLimit"),GETMEMUSE("getMemUse"),GETMEMSET("getMemSet"),
    GETCPULIMIT("getCpuLimit"),GETCPUUSE("getCpuUse"),GETSOCKETSUSE("getSocketsUse"),GETTHREADSUSE("getThreadsUse");
